...
class Gameboard {
    constructor(difficultySetting){
        ...
        function setupGame(difficultySetting) {
            ...
            MathJax.typeset() // CREDIT: https://docs.mathjax.org/en/latest/advanced/typeset.html call mathjax synchronous .typeset() method as HTML was changed from when document was first rendered 
            return questions;
    ...
    setUpNewTurn(variableValue){
        ...
        function addGridEventListeners(){
            ...
            function activateGameboardOverlay(clickEvent) {
                ...
                this.currentQuestionId = clickEvent.currentTarget.questionId; 
                ...
                function showOverlay(mjxContent){
                    ...
                    $('#choose-again-button').click(hideGameboardOverlay.bind(this)); // turn on event listeners for overlay buttons
                    $('#submit-player-answer-button').click(checkUserAnswer.bind(this)); 
                    $('#gameboard-overlay').removeClass('hide'); // finally, unhide

                    // EVENT LISTENER FOR #choose-again-button ELEMENT
                    function hideGameboardOverlay(clickEvent) {
                        clickEvent.preventDefault();
                        clickEvent.stopPropagation();
                    ...
                    function checkUserAnswer(submitEvent) {
