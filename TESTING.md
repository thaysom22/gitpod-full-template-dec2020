...
NOTE: I started the project tyring to follow a test-driven development (TDD) workflow, but found it very difficult to write effective and meaningful tests without having a clear and concrete idea of implementation details and program architecture. I therefore decided for this project to implement the Javascript functionality first, before later adding tests to practice using the Jasmine framework. FOr my next project I will aim to write unit tests parallel to the implementation.
...
### 3.3 Chrome lighthouse report

* A report generated by Google Chrome lighthouse tool can be found [here](images/lighthouse-mobile.pdf)
